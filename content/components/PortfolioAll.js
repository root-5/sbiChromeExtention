    ...
    return html`
        <div class="pt-5 max-sm:p-2.5 max-sm:overflow-x-auto flex flex-col gap-6">
            <div class="flex justify-start gap-8">
                <div>
                    <h2 class="lg:mb-1.5 text-green-800 text-lg font-semibold">サマリー</h2>
                    <table class="border-collapse bg-white shadow-md rounded-md overflow-hidden align-middle w-fit">
                        <thead class="text-white bg-gradient-to-br from-green-800 to-green-800 border-t-2 border-green-900 whitespace-nowrap">
                            <tr>
            ...
            <div>
                <h2 class="lg:mb-1.5 text-green-800 text-lg font-semibold">ポートフォリオ一覧</h2>
                <div class="overflow-x-auto shadow-md rounded-md">
                    <table class="w-full border-collapse bg-white text-sm whitespace-nowrap">
                        <thead class="text-white bg-gradient-to-br from-green-800 to-green-800 border-t-2 border-green-900">
                            <tr>
